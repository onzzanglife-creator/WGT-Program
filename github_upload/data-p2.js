...
be: {
    ...
    { vBase: "be", s: "We", p: "긍정", c: "hungry", kor: { 현재:"배가 고프다.", 과거:"배가 고팠다.", 미래:"배가 고플 것이다." }, s_kor: "우리는", b_en: "after the game", b_kor: "게임 후에", c_en: ["in the locker room", "at lunchtime"], c_kor: ["라커룸에서", "점심 때"] },
    ...
    { vBase: "be", s: "You", p: "의문", c: "late", kor: { 현재:"늦니?", 과거:"늦었니?", 미래:"늦을까?" }, s_kor: "너는", b_en: "for school", b_kor: "학교에", c_en: ["in the morning", "every day"], c_kor: ["아침에", "매일"] },
    { vBase: "be", s: "The bus", p: "긍정", c: "early", kor: { 현재:"일찍 온다.", 과거:"일찍 왔다.", 미래:"일찍 올 것이다." }, s_kor: "그 버스는", b_en: "at the station", b_kor: "역에", c_en: ["in the morning", "without delay"], c_kor: ["아침에", "지연 없이"] },
    ...
    { vBase: "be", s: "He", p: "의문", c: "ready", kor: { 현재:"준비가 되어 있니?", 과거:"준비가 되어 있었니?", 미래:"준비가 될까?" }, s_kor: "그는", b_en: "for the test", b_kor: "시험 준비가", c_en: ["in the classroom", "with his notes"], c_kor: ["교실에서", "그의 노트를 가지고"] },
    ...
    { vBase: "be", s: "The store", p: "긍정", c: "open", kor: { 현재:"문이 열려 있다.", 과거:"문이 열려 있었다.", 미래:"문이 열려 있을 것이다." }, s_kor: "그 가게는", b_en: "on Sundays", b_kor: "일요일마다", c_en: ["for the locals", "in the morning"], c_kor: ["지역 주민들을 위해", "아침에"] },
    ...
    { vBase: "be", s: "The presentation", p: "의문", c: "ready", kor: { 현재:"준비가 되어 있니?", 과거:"준비가 되어 있었니?", 미래:"준비가 될까?" }, s_kor: "발표는", b_en: "in the conference room", b_kor: "회의실에", c_en: ["on the screen", "for the clients"], c_kor: ["화면 상에", "고객들을 위해"] }
  ];
...
get: {
    ...
    { vBase: "get", s: "She", p: "긍정", c: "nervous", kor: { 현재:"긴장한다.", 과거:"긴장했다.", 미래:"긴장할 것이다." }, s_kor: "그녀는", b_en: "before the test", b_kor: "시험 전에", c_en: ["in the classroom", "easily"], c_kor: ["교실에서", "쉽게"] },
    { vBase: "get", s: "The phone", p: "부정", c: "hot", kor: { 현재:"뜨거워지지 않는다.", 과거:"뜨거워지지 않았다.", 미래:"뜨거워지지 않을 것이다." }, s_kor: "전화기가", b_en: "during the call", b_kor: "통화 중에", c_en: ["in the summer", "easily"], c_kor: ["여름에", "쉽게"] },
